...
sv=1000000
impact_list=[0, 0.001, 0.005, 0.01]
exp_result=[]
...
all_data=pd.DataFrame(exp_result[0], index=exp_result[0].index,columns=['imp0'])
all_data['imp0']=exp_result[0]
all_data['imp1']=exp_result[1]
all_data['imp2']=exp_result[2]
all_data['imp3']=exp_result[3]

all_data = all_data/all_data.iloc[0]

imp0_line=plt.plot(all_data['imp0'], c='blue', label='impact=0')
imp1_line=plt.plot(all_data['imp1'], c='black', label='impact=0.001')
imp2_line=plt.plot(all_data['imp2'], c='red', label='impact=0.005')
imp3_line=plt.plot(all_data['imp3'], c='green', label='impact=0.01')

plt.title('impact dependent')
plt.xlabel('time')
plt.xticks(rotation=45)
plt.ylabel('Portfolio')
plt.legend()
plt.show()
plt.savefig('impact_dependent_SL')